        ...
        <div className={props.visible ? "body-show" : "body-hidden"}>
            ...
            <div className="calendar-container">
                <div className="item-container">
                    <p className="calendar-text-header">Week 1 / September 15: &nbsp;</p>
                    <p className="calendar-text-body">Introduction to ACM</p>
                </div>
            </div>
            <div className="calendar-container">
                <div className="item-container">
                    <p className="calendar-text-header">Week 1 / September 16: &nbsp;</p>
                    <p className="calendar-text-body">UPE & ACM Cigna Event</p>
                </div>
            </div>
            <div className="calendar-container">
                <div className="item-container">
                    <p className="calendar-text-header">Week 2 / September 22: &nbsp;</p>
                    <p className="calendar-text-body">Fast Enterprise Info Session & Resume Critique</p>
                </div>
            </div>
            <div className="calendar-container">
                <div className="item-container">
                    <p className="calendar-text-header">Week 3 / September 29: &nbsp;</p>
            ...
            <div className="calendar-container">
                <div className="item-container">
                    <p className="calendar-text-header">Week 5 / October 13: &nbsp;</p>
                    <p className="calendar-text-body">Microsoft Learn Workshop</p>
                </div>
            </div>
            <div className="calendar-container">
                <div className="item-container">
                    <p className="calendar-text-header">Week 6 / October 20: &nbsp;</p>
